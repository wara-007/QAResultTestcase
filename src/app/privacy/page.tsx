...
export default function PrivacyPage() {
  return <LegalPage title="Privacy Policy" subtitle="Effective date: September 9, 2026">
    ...
    <section><h2>Google API data</h2><p>The application requests access to Google Sheets to read and update spreadsheets that users link to a project. It requests Google Drive file access to create folders, upload test evidence, and read files created or opened through the application. The application uses this data only to provide the features initiated by an authorized user.</p></section>
